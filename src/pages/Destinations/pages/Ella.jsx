      ...
      <div className="container mx-auto px-6 lg:px-20 py-16 space-y-12">
        <section ref={(el) => (sectionRefs.current[0] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Ella is a scenic hill-country town surrounded by tea plantations, misty mountains, and breathtaking views, making it one of Sri Lanka’s most popular backpacker destinations.
          </p>
        </section>
        ...
        <section ref={(el) => (sectionRefs.current[1] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Must-see attractions include the iconic Nine Arches Bridge, Ella Rock hike, Ravana Falls, and Little Adam’s Peak. The relaxed vibe and cafés also make Ella a traveler favorite.
          </p>
        </section>
        ...
        <section ref={(el) => (sectionRefs.current[2] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Visit March to June or December to February for the clearest views and the most comfortable hiking weather.
          </p>
        </section>
      </div>
    </div>
