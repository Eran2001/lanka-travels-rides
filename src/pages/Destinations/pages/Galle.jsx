      ...
      <div className="container mx-auto px-6 lg:px-20 py-16 space-y-12">
        <section ref={(el) => (sectionRefs.current[0] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Galle Fort, built by the Portuguese and later expanded by the Dutch, is a UNESCO World Heritage Site blending colonial architecture with stunning coastal views.
          </p>
        </section>
        ...
        <section ref={(el) => (sectionRefs.current[1] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Explore cobblestone streets, the lighthouse, Dutch Reformed Church, boutique cafés, art galleries, and the historic ramparts overlooking the ocean.
        ...
        <section ref={(el) => (sectionRefs.current[2] = el)} className="opacity-0">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Visit December to March for the best weather and lively atmosphere.
          </p>
        </section>
      </div>
    </div>
