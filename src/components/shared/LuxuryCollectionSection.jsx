...
const LuxuryCollectionSection = () => {
  ...
  >
    ...
    <p className="text-gray-700 mb-8 text-base md:text-lg">
      With over 40 years of trusted experience, Lanka Travel Rides is
      your reliable partner for exploring Sri Lanka. We offer modern,
      ...
      journey. Our 24-hour service, immediate replacement upon
      breakdown, and friendly, professional team guarantee peace of
      mind. Whether you’re discovering the island’s breathtaking
      landscapes or renting a vehicle for convenience, we provide
      trustworthy service at reasonable prices that make your travel
      truly unforgettable.
    </p>
    <Button
